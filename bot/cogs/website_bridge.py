            ...
            text(
                ...
                SELECT registration.player_id,
                       ...
                       'Подтвердите участие в туре «'
                           ...
                           || E'\n\nНеподтверждение участия не отменяет участие в туре. '
                           || 'Присутствие всех зарегистрированных игроков обязательно '
                           || 'вне зависимости от прохождения или непрохождения чек ина!',
                       :base_url || '/tournaments/' || tournament.slug
