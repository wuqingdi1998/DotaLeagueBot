...
import { TournamentDeletePanel } from "./TournamentDeletePanel";
import {
  ArchiveRostersAdmin,
  TeamResultsAdmin,
  ...
  return (
    <div className="admin-toolbar">
      <div>
        ...
        <span>
          Создаст всю сетку матчей даже без команд: пустые места получат название
          TBA. Доступные команды займут эти места, а матчи плей-офф сохранятся.
        </span>
      </div>
      <label>
        <span>Групп</span>
