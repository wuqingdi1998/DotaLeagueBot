  ...
  return (
    <main className="site-shell" data-theme={theme}>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Linken's Sphere Esports">
        ...
        <nav className="header-center" aria-label="Главная навигация">
          <a className="future-tournament" href="#tournament">
            <span>Будущий турнир</span>
            <strong>{tournament.name}</strong>
          </a>
          <a className="discord-link" href={tournament.discord_url} target="_blank" rel="noreferrer">
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-content">
          ...
          <p className="hero-footnote">Состав из {tournament.team_size} игроков · участие бесплатное · регистрация до {formatDayMonth(tournament.registration_deadline)}</p>
        </div>
      ...
      <section className="tournament-section" id="tournament">
        ...
        <div className="section-heading">
          <div>
            <p className="section-kicker">Активный турнир</p>
        ...
        {activeTab === "teams" && (
          <div className="tab-panel">
            ...
            <div className="teams-grid">
              ...
              {approvedTeams.length < tournament.max_teams && (
