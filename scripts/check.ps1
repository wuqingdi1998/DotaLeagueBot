...
try {
    ...
    Invoke-CheckedCommand $Python -m mypy database/core.py database/migrate.py cogs/website_bridge.py cogs/season_lobby_notifications.py cogs/season_nine_outreach.py services/season_lobby_notifications.py services/season_nine_outreach.py utils/website_notifications.py
